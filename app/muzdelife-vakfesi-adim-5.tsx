...
export default function MuzdelifeVakfesiAdim5Screen() {
  ...
  return (
    <View style={styles.root}>
      ...
      <Image
        source={require('../assets/images/muzdelifede_sabah_namazi.jpeg')}
              ...
              <View style={styles.blurBlock}>
                <View style={styles.bubble}>
                  <ScrollView
                    ...
                    nestedScrollEnabled
                  >
                    <Text style={styles.sectionTitle}>{t(`${k}.sabahNotuTitle`)}</Text>
                    <Text style={styles.duaText}>{t(`${k}.sabahNotu1`)}</Text>
                    <Text style={styles.listLine}>{t(`${k}.sabahNotu2`)}</Text>

                    <Text style={styles.sectionTitleSpaced}>{t(`${k}.vakfeLabel`)}</Text>
                    <Text style={styles.duaText}>{t(`${k}.vakfeDua`)}</Text>
                    <Text style={styles.meaningLabel}>{t(`${k}.meaningLabel`)}</Text>
                    <Text style={styles.meaningText}>{t(`${k}.vakfeMeaning`)}</Text>

                    <Text style={styles.sectionTitleSpaced}>{t(`${k}.mesharLabel`)}</Text>
                    <Text style={styles.duaText}>{t(`${k}.mesharDua`)}</Text>
                    <Text style={styles.meaningLabel}>{t(`${k}.meaningLabel`)}</Text>
                    <Text style={styles.meaningText}>{t(`${k}.mesharMeaning`)}</Text>
