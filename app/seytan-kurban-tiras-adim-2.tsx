...
const k = 'seytanKurbanTirasAdim2';

export default function SeytanKurbanTirasAdim2Screen() {
              ...
              <View style={styles.blurBlock}>
                <View style={styles.bubble}>
                  ...
                  >
                    ...
                    <Text style={styles.sectionTitleSpaced}>{t(`${k}.kesimLabel`)}</Text>
                    <Text style={styles.duaText}>{t(`${k}.kesimDua`)}</Text>
                    <Text style={styles.meaningLabel}>{t(`${k}.meaningLabel`)}</Text>
                    <Text style={styles.meaningText}>{t(`${k}.kesimMeaning`)}</Text>
                    ...
                    <Text style={styles.noteNext}>{t(`${k}.note6`)}</Text>
                  </ScrollView>
                </View>
              </View>
            </View>
