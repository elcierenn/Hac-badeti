...
const k = 'seytanKurbanTirasAdim1';

export default function SeytanKurbanTirasAdim1Screen() {
              ...
              <View style={styles.blurBlock}>
                <View style={styles.bubble}>
                  <ScrollView
                    ...
                    nestedScrollEnabled
                  >
                    <Text style={styles.sectionTitle}>{t(`${k}.tasAtarkenLabel`)}</Text>
                    <Text style={styles.duaText}>{t(`${k}.tasAtarkenPhrase`)}</Text>
                    <Text style={styles.meaningLabel}>{t(`${k}.meaningLabel`)}</Text>
                    <Text style={styles.meaningText}>{t(`${k}.tasAtarkenMeaning`)}</Text>

                    <Text style={styles.sectionTitleSpaced}>{t(`${k}.telbiyeSonLabel`)}</Text>
                    <Text style={styles.meaningText}>{t(`${k}.telbiyeSonBody`)}</Text>

                    <Text style={styles.sectionTitleSpaced}>{t(`${k}.taslamaSirasiTitle`)}</Text>
                    <Text style={styles.duaText}>{t(`${k}.taslama1`)}</Text>
                    <Text style={styles.listLine}>{t(`${k}.taslama2`)}</Text>
                    <Text style={styles.listLine}>{t(`${k}.taslama3`)}</Text>
                    <Text style={styles.listLine}>{t(`${k}.taslama4`)}</Text>
