...
const STEP_KEYS = [
  'minaGecelemeAdimlar.step1',
  'minaGecelemeAdimlar.step2',
  'minaGecelemeAdimlar.step3',
  'minaGecelemeAdimlar.step4',
] as const;

const STEP_DETAIL_HREFS: (Href | null)[] = [
  '/mina-geceleme-adim-1-hareket',
  '/mina-geceleme-adim-2-namaz',
  '/mina-geceleme-adim-3-gece',
  '/mina-geceleme-adim-4-mina',
];

const SCROLL_HINT_PAD = 8;

export default function MinaGecelemeAdimlarScreen() {
  ...
  return (
    <View style={styles.root}>
      <Image
        source={require('../assets/images/mina_geceleme.jpeg')}
