...
const k = 'seytanKurbanTirasGun2Adim1';

export default function SeytanKurbanTirasGun2Adim1Screen() {
  ...
  return (
    <View style={styles.root}>
      ...
      <Image
        source={require('../assets/images/cemresutununa_taslama.jpeg')}
              ...
              <View style={styles.blurBlock}>
                <View style={styles.bubble}>
                  ...
                  >
                    ...
                    <Text style={styles.duaText}>{t(`${k}.tasPhrase`)}</Text>
                    <Text style={styles.meaningText}>{t(`${k}.tasMeaning`)}</Text>

                    <Text style={styles.sectionTitleSpaced}>{t(`${k}.yediTasSonrasiLabel`)}</Text>
                    <Text style={styles.duaText}>{t(`${k}.yediTasDua`)}</Text>
                    <Text style={styles.meaningText}>{t(`${k}.yediTasDuaMeaning`)}</Text>
