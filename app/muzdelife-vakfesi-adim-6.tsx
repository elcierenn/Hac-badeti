...
const k = 'muzdelifeVakfesiAdim6';

export default function MuzdelifeVakfesiAdim6Screen() {
              ...
              <View style={styles.blurBlock}>
                <View style={styles.bubble}>
                  <ScrollView
                    ...
                    nestedScrollEnabled
                  >
                    <Text style={styles.sectionTitle}>{t(`${k}.yolaCikisLabel`)}</Text>
                    <Text style={styles.duaText}>{t(`${k}.yolaCikisDua`)}</Text>
                    <Text style={styles.meaningLabel}>{t(`${k}.meaningLabel`)}</Text>
                    <Text style={styles.meaningText}>{t(`${k}.yolaCikisMeaning`)}</Text>

                    <Text style={styles.sectionTitleSpaced}>{t(`${k}.telbiyeLabel`)}</Text>
                    <Text style={styles.duaText}>{t(`${k}.telbiye`)}</Text>
                    <Text style={styles.telbiyeNote}>{t(`${k}.telbiyeNote`)}</Text>
