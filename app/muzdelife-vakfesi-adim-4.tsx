...
const k = 'muzdelifeVakfesiAdim4';

export default function MuzdelifeVakfesiAdim4Screen() {
  ...
  return (
    <View style={styles.root}>
      ...
      <Image
        source={require('../assets/images/tas_toplama.jpeg')}
              ...
              <View style={styles.blurBlock}>
                <View style={styles.bubble}>
                  <ScrollView
                    ...
                    nestedScrollEnabled
                  >
                    <Text style={styles.sectionTitle}>{t(`${k}.tasSayilariTitle`)}</Text>
                    <Text style={styles.duaText}>{t(`${k}.tasSayi1`)}</Text>
                    <Text style={styles.listLine}>{t(`${k}.tasSayi2`)}</Text>
                    <Text style={styles.listLine}>{t(`${k}.tasSayi3`)}</Text>
                    <Text style={styles.listLine}>{t(`${k}.tasToplam49`)}</Text>
                    <Text style={styles.listLine}>{t(`${k}.tasToplam70`)}</Text>

                    <Text style={styles.sectionTitleSpaced}>{t(`${k}.ozelliklerTitle`)}</Text>
                    <Text style={styles.duaText}>{t(`${k}.ozellik1`)}</Text>
                    <Text style={styles.listLine}>{t(`${k}.ozellik2`)}</Text>
                    <Text style={styles.listLine}>{t(`${k}.ozellik3`)}</Text>
                    <Text style={styles.listLine}>{t(`${k}.ozellik4`)}</Text>
