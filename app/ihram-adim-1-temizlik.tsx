...
const MALE_KEYS = [
  'ihramAdim1Temizlik.male1',
  'ihramAdim1Temizlik.male2',
  'ihramAdim1Temizlik.male3',
  'ihramAdim1Temizlik.male4',
] as const;
const FEMALE_KEYS = [
  'ihramAdim1Temizlik.female1',
  'ihramAdim1Temizlik.female2',
  'ihramAdim1Temizlik.female3',
  'ihramAdim1Temizlik.female4',
] as const;

export default function IhramAdim1TemizlikScreen() {
  ...
  return (
    <View style={styles.root}>
      ...
      <Image
        source={require('../assets/images/genel_temizlik.jpeg')}
            ...
            <View style={styles.bubbleWrapper}>
              <View style={styles.blurBlock}>
                <View style={styles.bubble}>
                  <Text style={styles.bubbleLabel}>{t('ihramAdim1Temizlik.selectGender')}</Text>
                  <View style={styles.genderRow}>
                    <Pressable
                      ...
                      accessibilityLabel={t('ihramAdim1Temizlik.erkekA11y')}
                    ...
                    <Pressable
                      ...
                      accessibilityLabel={t('ihramAdim1Temizlik.kadinA11y')}
      ...
      <SafeAreaView style={styles.topSafe} pointerEvents="box-none" edges={['top', 'left', 'right']}>
        <View style={styles.topRow}>
          <Pressable
            ...
            accessibilityLabel={t('ihramAdim1Temizlik.backA11y')}
            accessibilityRole="button"
          >
