...
const k = 'muzdelifeVakfesiAdim3';

export default function MuzdelifeVakfesiAdim3Screen() {
  ...
  return (
    <View style={styles.root}>
      ...
      <Image
        source={require('../assets/images/müzdelifede_dua.jpeg')}
              ...
              <View style={styles.blurBlock}>
                <View style={styles.bubble}>
                  <ScrollView
                    ...
                    nestedScrollEnabled
                  >
                    <Text style={styles.sectionTitle}>{t(`${k}.istighfarLabel`)}</Text>
                    <Text style={styles.duaText}>{t(`${k}.istighfar`)}</Text>
                    <Text style={styles.meaningText}>{t(`${k}.istighfarMeaning`)}</Text>

                    <Text style={styles.sectionTitleSpaced}>{t(`${k}.telbiyeLabel`)}</Text>
                    <Text style={styles.duaText}>{t(`${k}.telbiye`)}</Text>

                    <Text style={styles.sectionTitleSpaced}>{t(`${k}.geceZikriLabel`)}</Text>
                    <Text style={styles.duaText}>{t(`${k}.geceZikriLine1`)}</Text>
                    <Text style={styles.zikrLine}>{t(`${k}.geceZikriLine2`)}</Text>
                    <Text style={styles.zikrLine}>{t(`${k}.geceZikriLine3`)}</Text>

                    <Text style={styles.sectionTitleSpaced}>{t(`${k}.tavsiyeLabel`)}</Text>
                    <Text style={styles.duaText}>{t(`${k}.tavsiyeDua`)}</Text>
                    <Text style={styles.meaningLabel}>{t(`${k}.meaningLabel`)}</Text>
                    <Text style={styles.meaningText}>{t(`${k}.tavsiyeMeaning`)}</Text>
