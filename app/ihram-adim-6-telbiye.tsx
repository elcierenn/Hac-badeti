...
export default function IhramAdim6TelbiyeScreen() {
  ...
  return (
    <View style={styles.root}>
      ...
      <Image
        source={require('../assets/images/telbiye_etmek.jpeg')}
              ...
              <View style={styles.blurBlock}>
                <View style={styles.bubble}>
                  <ScrollView
                    ...
                    nestedScrollEnabled
                  >
                    <Text style={styles.sectionLabel}>{t('ihramAdim6Telbiye.labelReading')}</Text>
                    <Text style={styles.bodyText}>{t('ihramAdim6Telbiye.reading')}</Text>
                    <Text style={[styles.sectionLabel, styles.sectionLabelSpaced]}>
                      {t('ihramAdim6Telbiye.labelMeaning')}
                    </Text>
                    <Text style={styles.bodyText}>{t('ihramAdim6Telbiye.meaning')}</Text>
                  </ScrollView>
                </View>
              </View>
            </View>
      ...
      <SafeAreaView style={styles.topSafe} pointerEvents="box-none" edges={['top', 'left', 'right']}>
        <View style={styles.topRow}>
          <Pressable
            ...
            accessibilityLabel={t('ihramAdim6Telbiye.backA11y')}
