...
const LINE_KEYS = [
  'ihramAdim4Namaz.line1',
  'ihramAdim4Namaz.line2',
  'ihramAdim4Namaz.line3',
  'ihramAdim4Namaz.line4',
  'ihramAdim4Namaz.line5',
  'ihramAdim4Namaz.line6',
] as const;

export default function IhramAdim4NamazScreen() {
      ...
      <SafeAreaView style={styles.topSafe} pointerEvents="box-none" edges={['top', 'left', 'right']}>
        <View style={styles.topRow}>
          <Pressable
            ...
            accessibilityLabel={t('ihramAdim4Namaz.backA11y')}
