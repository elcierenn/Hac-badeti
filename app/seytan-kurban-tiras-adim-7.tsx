...
const k = 'seytanKurbanTirasAdim7';

export default function SeytanKurbanTirasAdim7Screen() {
  ...
  return (
    <View style={styles.root}>
      ...
      <Image
        source={require('../assets/images/zemzemsuyu_icmek.jpeg')}
              ...
              <View style={styles.blurBlock}>
                <View style={styles.bubble}>
                  <ScrollView
                    ...
                    nestedScrollEnabled
                  >
                    <Text style={styles.sectionTitle}>{t(`${k}.icmedenOnceLabel`)}</Text>
                    <Text style={styles.duaText}>{t(`${k}.bismillah`)}</Text>

                    <Text style={styles.sectionTitleSpaced}>{t(`${k}.icerkenDuaLabel`)}</Text>
                    <Text style={styles.duaText}>{t(`${k}.icerkenDuaArap`)}</Text>
                    <Text style={styles.meaningText}>{t(`${k}.icerkenDuaMeaning`)}</Text>
