...
export default function KudumAdim1MescidScreen() {
  ...
  return (
    <View style={styles.root}>
      ...
      <Image
        source={require('../assets/images/mescid-i_haram.jpeg')}
              ...
              <View style={styles.blurBlock}>
                <View style={styles.bubble}>
                  <ScrollView
                    ...
                    nestedScrollEnabled
                  >
                    <Text style={styles.duaText}>{t('kudumAdim1Mescid.dua')}</Text>
                    <Text style={styles.meaningLabel}>{t('kudumAdim1Mescid.meaningLabel')}</Text>
                    <Text style={styles.meaningText}>{t('kudumAdim1Mescid.meaning')}</Text>
                    <Text style={styles.noteText}>{t('kudumAdim1Mescid.note')}</Text>
                  </ScrollView>
                </View>
              </View>
            </View>
      ...
      <SafeAreaView style={styles.topSafe} pointerEvents="box-none" edges={['top', 'left', 'right']}>
        <View style={styles.topRow}>
          <Pressable
            ...
            accessibilityLabel={t('kudumAdim1Mescid.backA11y')}
