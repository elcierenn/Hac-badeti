...
const k = 'seytanKurbanTirasAdim3';

export default function SeytanKurbanTirasAdim3Screen() {
  ...
  return (
    <View style={styles.root}>
      ...
      <Image
        source={require('../assets/images/minada_tras.jpeg')}
              ...
              <View style={styles.blurBlock}>
                <View style={styles.bubble}>
                  ...
                  >
                    ...
                    <Text style={styles.duaText}>{t(`${k}.dua`)}</Text>
                    <Text style={styles.meaningLabel}>{t(`${k}.meaningLabel`)}</Text>
                    <Text style={styles.meaningText}>{t(`${k}.duaMeaning`)}</Text>

                    <Text style={styles.sectionTitleSpaced}>{t(`${k}.erkekLabel`)}</Text>
                    <Text style={styles.duaText}>{t(`${k}.erkek1`)}</Text>
                    <Text style={styles.listLine}>{t(`${k}.erkek2`)}</Text>

                    <Text style={styles.sectionTitleSpaced}>{t(`${k}.kadinLabel`)}</Text>
                    <Text style={styles.duaText}>{t(`${k}.kadin1`)}</Text>
                    <Text style={styles.listLine}>{t(`${k}.kadin2`)}</Text>

                    <Text style={styles.sectionTitleSpaced}>{t(`${k}.tahallulTitle`)}</Text>
                    <Text style={styles.duaText}>{t(`${k}.tahallul1`)}</Text>
                    <Text style={styles.listLine}>{t(`${k}.tahallul2`)}</Text>
                    <Text style={styles.listLine}>{t(`${k}.tahallul3`)}</Text>
                    <Text style={styles.listLine}>{t(`${k}.tahallul4`)}</Text>
                    <Text style={styles.listLine}>{t(`${k}.tahallul5`)}</Text>
