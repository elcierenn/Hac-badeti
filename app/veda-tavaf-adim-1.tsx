...
const k = 'vedaTavafAdim1';

export default function VedaTavafAdim1Screen() {
  ...
  return (
    <View style={styles.root}>
      ...
      <Image
        source={require('../assets/images/kabede_son_tavaf.jpeg')}
              ...
              <View style={styles.blurBlock}>
                <View style={styles.bubble}>
                  ...
                  >
                    ...
                    <Text style={styles.sectionTitleSpaced}>{t(`${k}.vedaDuaLabel`)}</Text>
