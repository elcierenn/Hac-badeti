...
export default function IhramAdim5NiyetScreen() {
  ...
  return (
    <View style={styles.root}>
      ...
      <Image
        source={require('../assets/images/niyet_etme.jpeg')}
              ...
              <View style={styles.blurBlock}>
                <View style={styles.bubble}>
                  <ScrollView
                    ...
                    nestedScrollEnabled
                  >
                    <Text style={styles.blockText}>{t('ihramAdim5Niyet.line1')}</Text>
                    <Text style={styles.blockTextSecond}>{t('ihramAdim5Niyet.line2')}</Text>
                  </ScrollView>
                </View>
              </View>
            </View>
      ...
      <SafeAreaView style={styles.topSafe} pointerEvents="box-none" edges={['top', 'left', 'right']}>
        <View style={styles.topRow}>
          <Pressable
            ...
            accessibilityLabel={t('ihramAdim5Niyet.backA11y')}
