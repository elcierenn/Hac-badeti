...
const k = 'vedaTavafAdim4';

export default function VedaTavafAdim4Screen() {
  ...
  return (
    <View style={styles.root}>
      ...
      <Image
        source={require('../assets/images/kabe_onunde_son_dua.jpeg')}
              ...
              <View style={styles.blurBlock}>
                <View style={styles.bubble}>
                  <ScrollView
                    ...
                    nestedScrollEnabled
                  >
                    <Text style={styles.sectionTitle}>{t(`${k}.vedaDuaLabel`)}</Text>
                    <Text style={styles.duaText}>{t(`${k}.vedaDuaArap`)}</Text>
                    <Text style={styles.meaningText}>{t(`${k}.vedaDuaMeaning`)}</Text>

                    <Text style={styles.sectionTitleSpaced}>{t(`${k}.multezemDuaLabel`)}</Text>
                    <Text style={styles.duaText}>{t(`${k}.multezemDuaArap`)}</Text>
                    <Text style={styles.meaningText}>{t(`${k}.multezemDuaMeaning`)}</Text>
